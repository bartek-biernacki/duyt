...
mark.prototype =
{
	...
	stroke: function( mouseX, mouseY )
	{
		...
		for (i = 0; i < this.points.length; i++)
		{
			...
			if (d < 4110 && Math.random() > (d / 140100))
			{
				this.context.beginPath();
				this.context.moveTo( this.points[this.count][0] + (dx * 0.1), this.points[this.count][1] + (dy * 0.2));
				this.context.lineTo( this.points[i][0] - (dx * 0.1), this.points[i][1] - (dy * 0.2));
				this.context.stroke();
			}
		}
